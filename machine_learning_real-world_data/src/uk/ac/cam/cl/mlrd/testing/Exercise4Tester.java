...
import uk.ac.cam.cl.jp775.exercises.Exercise4;
...
public class Exercise4Tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double signResultSelf = implementation.signTest(split.validationSet, nbPredictions, nbPredictions);
        System.out.println("Sign test self results:");
        System.out.println(signResultSelf);
